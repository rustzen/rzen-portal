...
- [infra/password.rs](https://github.com/rustzen/rustzen-admin/blob/main/apps/server/src/infra/password.rs) - Argon2 password hashing implementation
- [crates/auth/src/auth/jwt.rs](https://github.com/rustzen/rustzen-admin/blob/main/crates/auth/src/auth/jwt.rs) - JWT utility functions
- [features/auth/service.rs](https://github.com/rustzen/rustzen-admin/blob/main/apps/server/src/features/auth/service.rs) - Authentication business logic
- [crates/auth/src/auth/middleware.rs](https://github.com/rustzen/rustzen-admin/blob/main/crates/auth/src/auth/middleware.rs) - JWT authentication middleware

🔗 **Complete Source Code**: [rustzen-admin server on GitHub](https://github.com/rustzen/rustzen-admin/tree/main/apps/server)
